...
export const Competencias = ({
  ...
  const getCEFR = (lvl) => {
    if (lvl < 20) return { label: 'A1', color: 'text-hub-muted' };
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <h1 className="text-xl font-black italic tracking-wider text-hub-strong mb-6">
        COMPETÊNCIAS
      </h1>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-hub-surface border border-hub-border rounded-xl p-6 shadow-xl">
          <h2 className="text-yellow-500 font-bold italic mb-1">
            RADAR DE COMPETÊNCIAS
          </h2>
          <p className="text-xs text-hub-faint mb-6 uppercase tracking-wider">
        ...
        <div className="bg-hub-surface border border-hub-border rounded-xl p-6 shadow-xl flex flex-col gap-5">
          {/* Cabeçalho */}
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-yellow-500 text-lg">文A</span>
              <h2 className="text-hub-strong font-bold">Inglês (Argos)</h2>
            </div>
            <p className="text-xs text-hub-faint">Meta: Nível C1 / Prep. TOEFL</p>
          </div>

          {/* Progresso CEFR */}
          <div>
            <div className="flex justify-between items-center text-xs font-bold text-hub-content mb-2">
          ...
          <div className="bg-hub-inner border border-hub-border rounded-xl p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-[9px] text-hub-faint font-bold">recorde</p>
              </div>
            </div>
                ...
                >
                  ...
                  <td className="py-3 text-right pr-2">
                    <button
                      ...
                      className="text-hub-faint hover:text-rose-500 transition-colors p-1 opacity-0 group-hover:opacity-100"
                    >
      ...
      {/* Soft Skills */}
      <div className="bg-hub-surface border border-hub-border rounded-xl p-6 shadow-xl">
        <h2 className="text-hub-strong font-bold mb-1 flex items-center gap-2">
              ...
              <div
                ...
                className={`border ${
                  isCom
                    ...
                    : 'border-hub-border bg-hub-inner'
                } rounded-xl p-5`}
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-hub-strong font-bold uppercase tracking-wide text-sm">
                    {category}
                  </h3>
                  <span
                    className={`text-xs font-bold ${
                      progress === 100 ? 'text-yellow-500' : 'text-hub-muted'
                    }`}
                  >
                    {progress}%
                  </span>
                  ...
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={`text-sm ${
                          item.checked
                            ? 'text-hub-faint line-through decoration-slate-600'
                            : 'text-hub-content group-hover:text-hub-strong transition-colors'
                        }`}
                      >
                        {item.text}
                      </span>
