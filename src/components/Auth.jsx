        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <button
               type="submit"
               disabled={isLoading}
               className="w-full mt-6 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 disabled:from-[#222222] disabled:to-[#1a1a1a] text-[#111111] disabled:text-hub-faint font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-yellow-500/25 active:scale-95"
            >
               {isLoading ? (
